...
struct EditView: View {
    ...
    init(location: Location, onSave: @escaping (Location) -> Void) {
        ...
        // Underscore allow us to create an instance of the property wrapper not the data inside the wrapper
    ...
    func fetchNearbyPlaces() async {
        ...
        do {
            ...
            let items = try JSONDecoder().decode(Result.self, from: data) //Got data back
            
            viewModel.pages = items.query.pages.values.sorted() //Success - convert the array values
